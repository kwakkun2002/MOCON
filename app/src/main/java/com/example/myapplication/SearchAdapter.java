...
public class SearchAdapter extends RecyclerView.Adapter<SearchAdapter.CustomViewHolder> {
    ...
    @NonNull
    @Override
    public SearchAdapter.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final SearchAdapter.CustomViewHolder customViewHolder, int i) {

...
public class ProfileAdapterOfChatData extends RecyclerView.Adapter<ProfileAdapterOfChatData.CustomViewHolder> {
    ...
    @NonNull
    @Override
    public ProfileAdapterOfChatData.CustomViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final ProfileAdapterOfChatData.CustomViewHolder customViewHolder, int i) {
